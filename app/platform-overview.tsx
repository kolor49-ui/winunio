const READY = [
  ...
  "Vitaszerkesztő: idézet, forrás, piszkozat, beillesztésvédelem",
  "Opcionális helyesírás-ellenőrzés (forduló, zárógondolat, jelentkezés)",
  ...
  return (
    <section className="layout-panel layout-panel-muted">
      <div className="layout-panel-header">
        ...
        <p className="hint">
          Az alábbi funkciók élesben használhatók.
        </p>
      </div>
