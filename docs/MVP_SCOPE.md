...
| Abuse — folytatás | Egyszer használható challenge + **TOTP minden kérésnél** + authenticator egyszeri beállítás |
...
6. Folytatáskérés csak teljes `published` forduló után; challenge + TOTP + authenticator beállítás (egyszer).
